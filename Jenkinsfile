     ...
     stages {
         ...
         stage('Deploying') {
              steps{
                  ...
                  withAWS([[$class: 'AmazonWebServicesCredentialsBinding', accessKeyVariable: "AWS_ACCESS_KEY_ID", credentialsId: 'blueocean', secretKeyVariable: "AWS_SECRET_ACESS_KEY_ID"]]) {
